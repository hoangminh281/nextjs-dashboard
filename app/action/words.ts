...
const FormSchema = z.object({
  ...
  pronunciation: z
    ...
    .trim()
    .min(1, { message: "Please input a pronunciation" }),
  definition: z
    .string({
      required_error: "Definition is required",
    })
    .trim()
    .min(1, { message: "Please input a definition" }),
  image: z
    .string({
  ...
  example: z
    ...
    .trim()
    .min(1, { message: "Please input a example" }),
  opposite: z
    .string({
      required_error: "Opposite is required",
    })
    .trim()
    .min(1, { message: "Please input an opposite" }),
});
